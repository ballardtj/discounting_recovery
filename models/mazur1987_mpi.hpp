...
namespace mazur1987_mpi_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/QRISdata/Q0992/models/mazur1987_mpi.stan");
    reader.add_event(115, 113, "end", "/QRISdata/Q0992/models/mazur1987_mpi.stan");
    return reader;
}
...
likelihood(const Eigen::Matrix<T0__, Eigen::Dynamic,1>& phi,
    ...
    try {
        ...
        for (int i = 1; i <= Nvalid; ++i) {
            ...
            stan::math::assign(u_a, (m_a / (1 + (k * pow(d_a,s)))));
            current_statement_begin__ = 37;
            stan::math::assign(u_b, (m_b / (1 + (k * pow(d_b,s)))));
...
class mazur1987_mpi_model : public prob_grad {
private:
    int Nsubj;
...
public:
    mazur1987_mpi_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "mazur1987_mpi_model_namespace::mazur1987_mpi_model";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "mazur1987_mpi_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef mazur1987_mpi_model_namespace::mazur1987_mpi_model stan_model;

STAN_REGISTER_MAP_RECT(1, mazur1987_mpi_model_namespace::likelihood_functor__)

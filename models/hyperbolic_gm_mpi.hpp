...
namespace hyperbolic_gm_mpi_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/QRISdata/Q0992/models/hyperbolic_gm_mpi.stan");
    reader.add_event(115, 113, "end", "/QRISdata/Q0992/models/hyperbolic_gm_mpi.stan");
    return reader;
}
...
likelihood(const Eigen::Matrix<T0__, Eigen::Dynamic,1>& phi,
    ...
    try {
        ...
        stan::math::assign(k,(get_base1(phi,1,"phi",1) + (get_base1(phi,2,"phi",1) * get_base1(theta,1,"theta",1))));
        ...
        stan::math::assign(s,(get_base1(phi,3,"phi",1) + (get_base1(phi,4,"phi",1) * get_base1(theta,2,"theta",1))));
        ...
        stan::math::assign(sigma,(get_base1(phi,5,"phi",1) + (get_base1(phi,6,"phi",1) * get_base1(theta,3,"theta",1))));
        ...
        for (int i = 1; i <= Nvalid; ++i) {
            ...
            stan::math::assign(u_a, (m_a / pow((1 + (k * d_a)),s)));
            current_statement_begin__ = 37;
            stan::math::assign(u_b, (m_b / pow((1 + (k * d_b)),s)));
...
class hyperbolic_gm_mpi_model : public prob_grad {
private:
    int Nsubj;
...
public:
    hyperbolic_gm_mpi_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "hyperbolic_gm_mpi_model_namespace::hyperbolic_gm_mpi_model";
        ...
        try {
            ...
            validate_non_negative_index("k_raw", "Nsubj", Nsubj);
            ...
            validate_non_negative_index("s_raw", "Nsubj", Nsubj);
            num_params_r__ += Nsubj;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        if (!(context__.contains_r("k_mean")))
            throw std::runtime_error("variable k_mean missing");
        vals_r__ = context__.vals_r("k_mean");
        pos__ = 0U;
        context__.validate_dims("initialization", "k_mean", "double", context__.to_vec());
        double k_mean(0);
        k_mean = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0,k_mean);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable k_mean: ") + e.what());
        }

        if (!(context__.contains_r("k_sd")))
            throw std::runtime_error("variable k_sd missing");
        vals_r__ = context__.vals_r("k_sd");
        pos__ = 0U;
        context__.validate_dims("initialization", "k_sd", "double", context__.to_vec());
        double k_sd(0);
        k_sd = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0,k_sd);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable k_sd: ") + e.what());
        }
        ...
        pos__ = 0U;
        validate_non_negative_index("k_raw", "Nsubj", Nsubj);
        context__.validate_dims("initialization", "k_raw", "vector_d", context__.to_vec(Nsubj));
        vector_d k_raw(static_cast<Eigen::VectorXd::Index>(Nsubj));
        for (int j1__ = 0U; j1__ < Nsubj; ++j1__)
            k_raw(j1__) = vals_r__[pos__++];
        try {
            writer__.vector_lb_unconstrain(0,k_raw);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable k_raw: ") + e.what());
        }

        if (!(context__.contains_r("s_mean")))
            throw std::runtime_error("variable s_mean missing");
        vals_r__ = context__.vals_r("s_mean");
        pos__ = 0U;
        context__.validate_dims("initialization", "s_mean", "double", context__.to_vec());
        double s_mean(0);
        s_mean = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0,s_mean);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable s_mean: ") + e.what());
        }

        if (!(context__.contains_r("s_sd")))
            throw std::runtime_error("variable s_sd missing");
        vals_r__ = context__.vals_r("s_sd");
        pos__ = 0U;
        context__.validate_dims("initialization", "s_sd", "double", context__.to_vec());
        double s_sd(0);
        s_sd = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0,s_sd);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable s_sd: ") + e.what());
        }

        if (!(context__.contains_r("s_raw")))
            throw std::runtime_error("variable s_raw missing");
        vals_r__ = context__.vals_r("s_raw");
        pos__ = 0U;
        validate_non_negative_index("s_raw", "Nsubj", Nsubj);
        context__.validate_dims("initialization", "s_raw", "vector_d", context__.to_vec(Nsubj));
        vector_d s_raw(static_cast<Eigen::VectorXd::Index>(Nsubj));
        for (int j1__ = 0U; j1__ < Nsubj; ++j1__)
            s_raw(j1__) = vals_r__[pos__++];
        try {
            writer__.vector_lb_unconstrain(0,s_raw);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable s_raw: ") + e.what());
        }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            local_scalar_t__ k_mean;
            (void) k_mean;  // dummy to suppress unused var warning
            if (jacobian__)
                k_mean = in__.scalar_lb_constrain(0,lp__);
            else
                k_mean = in__.scalar_lb_constrain(0);

            local_scalar_t__ k_sd;
            (void) k_sd;  // dummy to suppress unused var warning
            if (jacobian__)
                k_sd = in__.scalar_lb_constrain(0,lp__);
            else
                k_sd = in__.scalar_lb_constrain(0);

            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  k_raw;
            (void) k_raw;  // dummy to suppress unused var warning
            if (jacobian__)
                k_raw = in__.vector_lb_constrain(0,Nsubj,lp__);
            else
                k_raw = in__.vector_lb_constrain(0,Nsubj);

            local_scalar_t__ s_mean;
            (void) s_mean;  // dummy to suppress unused var warning
            if (jacobian__)
                s_mean = in__.scalar_lb_constrain(0,lp__);
            else
                s_mean = in__.scalar_lb_constrain(0);

            local_scalar_t__ s_sd;
            (void) s_sd;  // dummy to suppress unused var warning
            if (jacobian__)
                s_sd = in__.scalar_lb_constrain(0,lp__);
            else
                s_sd = in__.scalar_lb_constrain(0);

            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  s_raw;
            (void) s_raw;  // dummy to suppress unused var warning
            if (jacobian__)
                s_raw = in__.vector_lb_constrain(0,Nsubj,lp__);
            else
                s_raw = in__.vector_lb_constrain(0,Nsubj);
            ...
            lp_accum__.add(normal_log<propto__>(k_mean, 0, 1));
            current_statement_begin__ = 99;
            lp_accum__.add(normal_log<propto__>(k_sd, 0, 1));
            current_statement_begin__ = 101;
            lp_accum__.add(normal_log<propto__>(s_mean, 0, 1));
            current_statement_begin__ = 102;
            lp_accum__.add(normal_log<propto__>(s_sd, 0, 1));
            ...
            lp_accum__.add(normal_log<propto__>(s_raw, 0, 1));
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        names__.resize(0);
        names__.push_back("k_mean");
        names__.push_back("k_sd");
        names__.push_back("k_raw");
        names__.push_back("s_mean");
        names__.push_back("s_sd");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "hyperbolic_gm_mpi_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        double k_mean = in__.scalar_lb_constrain(0);
        double k_sd = in__.scalar_lb_constrain(0);
        vector_d k_raw = in__.vector_lb_constrain(0,Nsubj);
        double s_mean = in__.scalar_lb_constrain(0);
        double s_sd = in__.scalar_lb_constrain(0);
        vector_d s_raw = in__.vector_lb_constrain(0,Nsubj);
        ...
        vars__.push_back(k_mean);
        vars__.push_back(k_sd);
            for (int k_0__ = 0; k_0__ < Nsubj; ++k_0__) {
            vars__.push_back(k_raw[k_0__]);
            }
        vars__.push_back(s_mean);
        vars__.push_back(s_sd);
            for (int k_0__ = 0; k_0__ < Nsubj; ++k_0__) {
            vars__.push_back(s_raw[k_0__]);
            }
    ...
    static std::string model_name() {
        return "hyperbolic_gm_mpi_model";
    }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        param_name_stream__ << "k_mean";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "k_sd";
        param_names__.push_back(param_name_stream__.str());
        ...
        param_name_stream__.str(std::string());
        param_name_stream__ << "s_mean";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "s_sd";
        param_names__.push_back(param_name_stream__.str());
        for (int k_0__ = 1; k_0__ <= Nsubj; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "s_raw" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        param_name_stream__.str(std::string());
...
typedef hyperbolic_gm_mpi_model_namespace::hyperbolic_gm_mpi_model stan_model;

STAN_REGISTER_MAP_RECT(1, hyperbolic_gm_mpi_model_namespace::likelihood_functor__)

...
namespace hyperbolic_nontruncated_mpi_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/QRISdata/Q0992/models/hyperbolic_nontruncated_mpi.stan");
    reader.add_event(102, 100, "end", "/QRISdata/Q0992/models/hyperbolic_nontruncated_mpi.stan");
    return reader;
}
...
class hyperbolic_nontruncated_mpi_model : public prob_grad {
private:
    int Nsubj;
...
public:
    hyperbolic_nontruncated_mpi_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "hyperbolic_nontruncated_mpi_model_namespace::hyperbolic_nontruncated_mpi_model";
    ...
    ~hyperbolic_nontruncated_mpi_model() { }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(lognormal_log<propto__>(k_mean, 0, 1));
            current_statement_begin__ = 90;
            lp_accum__.add(cauchy_log<propto__>(k_sd, 0, 1));
            current_statement_begin__ = 92;
            lp_accum__.add(cauchy_log<propto__>(sigma_mean, 0, 1));
            current_statement_begin__ = 93;
            lp_accum__.add(cauchy_log<propto__>(sigma_sd, 0, 1));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "hyperbolic_nontruncated_mpi_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "hyperbolic_nontruncated_mpi_model";
    }
...
typedef hyperbolic_nontruncated_mpi_model_namespace::hyperbolic_nontruncated_mpi_model stan_model;

STAN_REGISTER_MAP_RECT(1, hyperbolic_nontruncated_mpi_model_namespace::likelihood_functor__)

...
namespace exponential_nontruncated_mpi_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/QRISdata/Q0992/models/exponential_nontruncated_mpi.stan");
    reader.add_event(102, 100, "end", "/QRISdata/Q0992/models/exponential_nontruncated_mpi.stan");
    return reader;
}
...
likelihood(const Eigen::Matrix<T0__, Eigen::Dynamic,1>& phi,
    ...
    try {
        ...
        for (int i = 1; i <= Nvalid; ++i) {
            ...
            stan::math::assign(u_a, (m_a * stan::math::exp((-(d_a) * k))));
            current_statement_begin__ = 36;
            stan::math::assign(u_b, (m_b * stan::math::exp((-(d_b) * k))));
...
class exponential_nontruncated_mpi_model : public prob_grad {
private:
    int Nsubj;
...
public:
    exponential_nontruncated_mpi_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "exponential_nontruncated_mpi_model_namespace::exponential_nontruncated_mpi_model";
    ...
    ~exponential_nontruncated_mpi_model() { }
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        try {
            writer__.scalar_unconstrain(k_mean);
        } catch (const std::exception& e) { 
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                k_mean = in__.scalar_constrain(lp__);
            else
                k_mean = in__.scalar_constrain();
            ...
            if (jacobian__)
                k_raw = in__.vector_constrain(Nsubj,lp__);
            else
                k_raw = in__.vector_constrain(Nsubj);
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "exponential_nontruncated_mpi_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        double k_mean = in__.scalar_constrain();
        double k_sd = in__.scalar_lb_constrain(0);
        vector_d k_raw = in__.vector_constrain(Nsubj);
    ...
    static std::string model_name() {
        return "exponential_nontruncated_mpi_model";
    }
...
typedef exponential_nontruncated_mpi_model_namespace::exponential_nontruncated_mpi_model stan_model;

STAN_REGISTER_MAP_RECT(1, exponential_nontruncated_mpi_model_namespace::likelihood_functor__)

...
namespace const_sens_mpi_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/QRISdata/Q0992/models/const_sens_mpi.stan");
    reader.add_event(115, 113, "end", "/QRISdata/Q0992/models/const_sens_mpi.stan");
    return reader;
}
...
likelihood(const Eigen::Matrix<T0__, Eigen::Dynamic,1>& phi,
    ...
    try {
        ...
        stan::math::assign(alpha,(get_base1(phi,1,"phi",1) + (get_base1(phi,2,"phi",1) * get_base1(theta,1,"theta",1))));
        ...
        stan::math::assign(beta,(get_base1(phi,3,"phi",1) + (get_base1(phi,4,"phi",1) * get_base1(theta,2,"theta",1))));
        ...
        for (int i = 1; i <= Nvalid; ++i) {
            ...
            stan::math::assign(u_a, (m_a * stan::math::exp(-(pow((alpha * d_a),beta)))));
            current_statement_begin__ = 37;
            stan::math::assign(u_b, (m_b * stan::math::exp(-(pow((alpha * d_b),beta)))));
...
class const_sens_mpi_model : public prob_grad {
private:
    int Nsubj;
...
public:
    const_sens_mpi_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "const_sens_mpi_model_namespace::const_sens_mpi_model";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "const_sens_mpi_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef const_sens_mpi_model_namespace::const_sens_mpi_model stan_model;

STAN_REGISTER_MAP_RECT(1, const_sens_mpi_model_namespace::likelihood_functor__)

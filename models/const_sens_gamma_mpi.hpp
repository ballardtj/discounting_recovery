...
namespace const_sens_gamma_mpi_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/QRISdata/Q0992/models/const_sens_gamma_mpi.stan");
    reader.add_event(115, 113, "end", "/QRISdata/Q0992/models/const_sens_gamma_mpi.stan");
    return reader;
}
...
class const_sens_gamma_mpi_model : public prob_grad {
private:
    int Nsubj;
...
public:
    const_sens_gamma_mpi_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "const_sens_gamma_mpi_model_namespace::const_sens_gamma_mpi_model";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(gamma_log<propto__>(alpha, alpha_shape, inv(alpha_scale)));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "const_sens_gamma_mpi_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "const_sens_gamma_mpi_model";
    }
...
typedef const_sens_gamma_mpi_model_namespace::const_sens_gamma_mpi_model stan_model;

STAN_REGISTER_MAP_RECT(1, const_sens_gamma_mpi_model_namespace::likelihood_functor__)

...
namespace prop_diff_PL_mpi_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/QRISdata/Q0992/models/prop_diff_PL_mpi.stan");
    reader.add_event(100, 98, "end", "/QRISdata/Q0992/models/prop_diff_PL_mpi.stan");
    return reader;
}
...
likelihood(const Eigen::Matrix<T0__, Eigen::Dynamic,1>& phi,
    ...
    try {
        ...
        stan::math::assign(delta,get_base1(theta,1,"theta",1));
        ...
        stan::math::assign(sigma,get_base1(theta,2,"theta",1));
...
class prop_diff_PL_mpi_model : public prob_grad {
private:
    int Nsubj;
...
public:
    prop_diff_PL_mpi_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "prop_diff_PL_mpi_model_namespace::prop_diff_PL_mpi_model";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            (void) delta;  // dummy to suppress unused var warning
            if (jacobian__)
                delta = in__.vector_constrain(Nsubj,lp__);
            else
                delta = in__.vector_constrain(Nsubj);
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "prop_diff_PL_mpi_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        vector_d delta = in__.vector_constrain(Nsubj);
...
typedef prop_diff_PL_mpi_model_namespace::prop_diff_PL_mpi_model stan_model;

STAN_REGISTER_MAP_RECT(1, prop_diff_PL_mpi_model_namespace::likelihood_functor__)

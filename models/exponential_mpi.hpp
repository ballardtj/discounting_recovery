...
namespace exponential_mpi_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/QRISdata/Q0992/models/exponential_mpi.stan");
    reader.add_event(102, 100, "end", "/QRISdata/Q0992/models/exponential_mpi.stan");
    return reader;
}
...
class exponential_mpi_model : public prob_grad {
private:
    int Nsubj;
...
public:
    exponential_mpi_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "exponential_mpi_model_namespace::exponential_mpi_model";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "exponential_mpi_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef exponential_mpi_model_namespace::exponential_mpi_model stan_model;

STAN_REGISTER_MAP_RECT(1, exponential_mpi_model_namespace::likelihood_functor__)

...
namespace mcclure2007_PL_mpi_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/QRISdata/Q0992/models/mcclure2007_PL_mpi.stan");
    reader.add_event(98, 96, "end", "/QRISdata/Q0992/models/mcclure2007_PL_mpi.stan");
    return reader;
}
...
likelihood(const Eigen::Matrix<T0__, Eigen::Dynamic,1>& phi,
    ...
    try {
        ...
        stan::math::assign(sigma,get_base1(theta,4,"theta",1));
...
class mcclure2007_PL_mpi_model : public prob_grad {
private:
    int Nsubj;
...
public:
    mcclure2007_PL_mpi_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "mcclure2007_PL_mpi_model_namespace::mcclure2007_PL_mpi_model";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(normal_log<propto__>(delta, 0, 5));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "mcclure2007_PL_mpi_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "mcclure2007_PL_mpi_model";
    }
...
typedef mcclure2007_PL_mpi_model_namespace::mcclure2007_PL_mpi_model stan_model;

STAN_REGISTER_MAP_RECT(1, mcclure2007_PL_mpi_model_namespace::likelihood_functor__)

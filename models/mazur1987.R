...
mazur_likelihood=function(m_a,    #magnitude of option a
                               d_a,    #delay associated with option a
                               m_b,    #magnitude of option b
                               d_b,    #delay associated with option b
                               k,      #discount factor, k > 0
                               s,      #discount exponent, s > 0
...
mazur_wrapper=function(pars,dat){
  #extract pars
  k=pars[1]
  s=pars[2]
  sigma=pars[3]

  p_a = mazur_likelihood(dat$m_a,dat$d_a,dat$m_b,dat$d_b,
                             k,s,sigma)

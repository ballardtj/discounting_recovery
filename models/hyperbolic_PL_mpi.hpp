...
namespace hyperbolic_PL_mpi_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/QRISdata/Q0992/models/hyperbolic_PL_mpi.stan");
    reader.add_event(86, 84, "end", "/QRISdata/Q0992/models/hyperbolic_PL_mpi.stan");
    return reader;
}
...
class hyperbolic_PL_mpi_model : public prob_grad {
private:
    int Nsubj;
...
public:
    hyperbolic_PL_mpi_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "hyperbolic_PL_mpi_model_namespace::hyperbolic_PL_mpi_model";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "hyperbolic_PL_mpi_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "hyperbolic_PL_mpi_model";
    }
...
typedef hyperbolic_PL_mpi_model_namespace::hyperbolic_PL_mpi_model stan_model;

STAN_REGISTER_MAP_RECT(1, hyperbolic_PL_mpi_model_namespace::likelihood_functor__)

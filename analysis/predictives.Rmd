...
pp_data <- foreach(i = 1:Nsamp,.combine='rbind') %dopar% {
    ...
    hyperbolic_likelihood(dat$m_a,dat$d_a,dat$m_b,dat$d_b,
                          posts$k_raw[samples[i],dat$subject]*posts$k_sd[samples[i]] + posts$k_mean[samples[i]],
                          posts$sigma_raw[samples[i],dat$subject]*posts$sigma_sd[samples[i]] + posts$sigma_mean[samples[i]])
